...
=======
      ...
      // turret 
      turretSubsystem.setDefaultCommand(new ManualTurretCommand(turretSubsystem, ()->deaden(Buttons.secondaryJoystick.getTriggerAxis(Hand.kLeft)), ()->deaden(Buttons.secondaryJoystick.getTriggerAxis(Hand.kRight))));
>>>>>>> e887a2d9761597a0efca33e497f0d9e85dd2cb0a
...
=======
      ...
      Buttons.secondaryLB.toggleWhenPressed(new BlasterDistanceBasedCommand(blasterSubsystem, RobotMap.LidarSensor));
...
=======
    autoChooser.addOption("Snag N' Yeet", new SnagNYeetCommandGroup(driveTrainSubsystem, intakeSubsystem, turretSubsystem, RobotMap.LidarSensor));
    ...
    autoChooser.addOption("Yeet3PushNom3", new Yeet3PushNom3(driveTrainSubsystem, intakeSubsystem, turretSubsystem, blasterSubsystem, RobotMap.LidarSensor, conveyorSubsystem));
    autoChooser.addOption("Yeet3Nom3", new Yeet3Nom3(driveTrainSubsystem, intakeSubsystem, turretSubsystem, blasterSubsystem, RobotMap.LidarSensor, conveyorSubsystem));
    autoChooser.addOption("PushNom2Yeet5Nom1", new PushNom2Yeet5Nom1(driveTrainSubsystem, intakeSubsystem, turretSubsystem, blasterSubsystem, RobotMap.LidarSensor, conveyorSubsystem));
    autoChooser.setDefaultOption("yeet3", new Yeet3(turretSubsystem, driveTrainSubsystem, conveyorSubsystem, intakeSubsystem, RobotMap.LidarSensor));
>>>>>>> e887a2d9761597a0efca33e497f0d9e85dd2cb0a
